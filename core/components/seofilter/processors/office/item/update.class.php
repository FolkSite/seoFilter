 ...
 * Update an Item
 */
class seofilterOfficeItemUpdateProcessor extends modObjectUpdateProcessor {
	...
	public function beforeSet() {
		...
		if (empty($id)) {
			return $this->modx->lexicon('seofilter_item_err_ns');
		}
...
return 'seofilterOfficeItemUpdateProcessor';
